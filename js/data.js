...
export const georgianPhrases = [
    { 
        phrase: "გამარჯობა", 
        russianPhrase: "Здравствуйте", 
        words: ["გამარჯობა"],
        comment: "Hello (formal greeting)"
    },
    { 
        phrase: "მე მიყვარს საქართველო", 
        russianPhrase: "Я люблю Грузию", 
        words: ["მე", "მიყვარს", "საქართველო"],
        comment: "I love Georgia"
    },
    { 
        phrase: "სად არის ტუალეტი", 
        russianPhrase: "Где туалет", 
        words: ["სად", "არის", "ტუალეტი"],
        comment: "Where is the bathroom"
    },
    { 
        phrase: "დიახ მადლობა", 
        russianPhrase: "Да спасибо", 
        words: ["დიახ", "მადლობა"],
        comment: "Yes thank you"
    },
    { 
        phrase: "არა გმადლობთ", 
        russianPhrase: "Нет спасибо", 
        words: ["არა", "გმადლობთ"],
        comment: "No thank you"
    },
    { 
        phrase: "რა გქვია", 
        russianPhrase: "Как тебя зовут", 
        words: ["რა", "გქვია"],
        comment: "What is your name"
    },
    { 
        phrase: "მე მქვია ილია", 
        russianPhrase: "Меня зовут Илья", 
        words: ["მე", "მქვია", "ილია"],
        comment: "My name is Ilya"
    },
    { 
        phrase: "კარგად ხარ", 
        russianPhrase: "Как дела", 
        words: ["კარგად", "ხარ"],
        comment: "How are you"
    },
    { 
        phrase: "მე კარგად ვარ", 
        russianPhrase: "У меня хорошо", 
        words: ["მე", "კარგად", "ვარ"],
        comment: "I am fine"
    },
    { 
        phrase: "რა ღირს", 
        russianPhrase: "Сколько стоит", 
        words: ["რა", "ღირს"],
        comment: "How much does it cost"
    },
    { 
        phrase: "მე არ ვიცი", 
        russianPhrase: "Я не знаю", 
        words: ["მე", "არ", "ვიცი"],
        comment: "I don't know"
    },
    { 
        phrase: "დახმარება სჭირდება", 
        russianPhrase: "Мне нужна помощь", 
        words: ["დახმარება", "სჭირდება"],
        comment: "I need help"
    },
    { 
        phrase: "წყალი მინდა", 
        russianPhrase: "Я хочу воды", 
        words: ["წყალი", "მინდა"],
        comment: "I want water"
    },
    { 
        phrase: "საით მიდიხართ", 
        russianPhrase: "Куда вы идете", 
        words: ["საით", "მიდიხართ"],
        comment: "Where are you going"
    },
    { 
        phrase: "რა სურს", 
        russianPhrase: "Что вы хотите", 
        words: ["რა", "სურს"],
